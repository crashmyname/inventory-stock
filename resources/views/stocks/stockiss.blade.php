...
@section('content')
        ...
        <div class="row row-cards">
            <div class="col-12">
                <div class="card-header">
                    <h4 class="card-title">Menu Stock ISS</h4>
                </div>
                <div class="card-body">
    ...
    <script>
      var getStockISS = "{{route('stockiss')}}";
      var createStockISS = "{{url('/stock')}}";
      var editStockISS = "{{url('/stock')}}";
      var deleteStockISS = "{{url('/stock')}}";
      var getApiEmployee = "{{url('/apidata')}}";
      var csrfToken = "{{ csrf_token() }}";
      var getBarangISS = "{{route('getbarang')}}";
      var importStock = "{{url('/stock/import')}}";
    </script>
    <script src="{{asset('js/stockiss.js')}}"></script>
@endsection
