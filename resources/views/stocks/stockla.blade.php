...
@section('content')
        ...
        <div class="row row-cards">
            <div class="col-12">
                <div class="card-header">
                    <h4 class="card-title">Menu Stock LA</h4>
                </div>
                <div class="card-body">
    ...
    <script>
      var getStockLa = "{{route('stockla')}}";
      var createStockLa = "{{url('/stock')}}";
      var editStockLa = "{{url('/stock')}}";
      var deleteStockLa = "{{url('/stock')}}";
      var getApiEmployee = "{{url('/apidata')}}";
      var csrfToken = "{{ csrf_token() }}";
      var getBarangLa = "{{route('getbarang')}}";
      var importStock = "{{url('/stock/import')}}";
    </script>
    <script src="{{asset('js/stockla.js')}}"></script>
@endsection
