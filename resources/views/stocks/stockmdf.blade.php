...
@section('content')
        ...
        <div class="row row-cards">
            <div class="col-12">
                <div class="card-header">
                    <h4 class="card-title">Menu Stock MDF</h4>
                </div>
                <div class="card-body">
    ...
    <script>
      var getStockMDF = "{{route('stockmdf')}}";
      var createStockMDF = "{{url('/stock')}}";
      var editStockMDF = "{{url('/stock')}}";
      var deleteStockMDF = "{{url('/stock')}}";
      var getApiEmployee = "{{url('/apidata')}}";
      var csrfToken = "{{ csrf_token() }}";
      var importStock = "{{url('/stock/import')}}";
      var getBarangMDF = "{{route('getbarang')}}";
    </script>
    <script src="{{asset('js/stockmdf.js')}}"></script>
@endsection
