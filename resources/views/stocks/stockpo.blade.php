...
@section('content')
        ...
        <div class="row row-cards">
            <div class="col-12">
                <div class="card-header">
                    <h4 class="card-title">Menu Stock PO</h4>
                </div>
                <div class="card-body">
    ...
    <script>
      var getStockPO = "{{route('stockpo')}}";
      var createStockPO = "{{url('/stock')}}";
      var editStockPO = "{{url('/stock')}}";
      var deleteStockPO = "{{url('/stock')}}";
      var getApiEmployee = "{{url('/apidata')}}";
      var csrfToken = "{{ csrf_token() }}";
      var importStock = "{{url('/stock/import')}}";
      var getBarangPO = "{{route('getbarang')}}";
    </script>
    <script src="{{asset('js/stockpo.js')}}"></script>
@endsection