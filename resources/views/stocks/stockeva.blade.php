...
@section('content')
        ...
        <div class="row row-cards">
            <div class="col-12">
                <div class="card-header">
                    <h4 class="card-title">Menu Stock EVA</h4>
                </div>
                <div class="card-body">
                ...
                <form id="formaddstock" action="" enctype="multipart/form-data" method="post">
                    ...
                    <div class="modal-body">
                        <div class="mb-3">
                            ...
                            <select name="code_barang" id="code_barang" class="form-control select2">
            ...
            <div class="modal-content">
                <form id="formeditstock" action="" enctype="multipart/form-data" method="post">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row" style="{{auth()->user()->role == 'Administrator' ? '' : 'display:none;'}}">
                            <div class="col-lg-12">
                                <div class="mb-3">
                                    <label class="form-label">Stock</label>
                                    <div class="input-group input-group-flat">
    ...
    <script>
      var getStockEVA = "{{route('stockeva')}}";
      var createStockEVA = "{{url('/stock')}}";
      var editStockEVA = "{{url('/stock')}}";
      var deleteStockEVA = "{{url('/stock')}}";
      var getApiEmployee = "{{url('/apidata')}}";
      var csrfToken = "{{ csrf_token() }}";
      var importStock = "{{url('/stock/import')}}";
      var getBarangEVA = "{{route('getbarang')}}";
    </script>
    <script src="{{asset('js/stockeva.js')}}"></script>
@endsection