...
@section('content')
        ...
        <div class="row row-cards">
            <div class="col-12">
                <div class="card-header">
                    <h4 class="card-title">Menu Stock PP</h4>
                </div>
                <div class="card-body">
    ...
    <script>
      var getStockPP = "{{route('stockpp')}}";
      var createStockPP = "{{url('/stock')}}";
      var editStockPP = "{{url('/stock')}}";
      var deleteStockPP = "{{url('/stock')}}";
      var getApiEmployee = "{{url('/apidata')}}";
      var csrfToken = "{{ csrf_token() }}";
      var importStock = "{{url('/stock/import')}}";
      var getBarangPP = "{{route('getbarang')}}";
    </script>
    <script src="{{asset('js/stockpp.js')}}"></script>
@endsection